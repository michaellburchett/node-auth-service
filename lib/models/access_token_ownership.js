...
const AuthorizationCode = require('./authorization_code.js');

class AccessTokenOwnership extends AppModel {
    ...
    relationships() {
        return {
            belongsTo: {
                ...
                user_id: User,
                client_id: Client,
                authorization_code_id: AuthorizationCode,
            }
        }
    }
...
module.exports = AccessTokenOwnership;