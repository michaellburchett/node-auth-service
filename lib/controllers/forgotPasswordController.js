...
module.exports.get = [
    function(req, res) {
        res.render('forgot_password', { errorMessage: req.flash('errorMessage')[0], successMessage: req.flash('successMessage')[0] });
    }
];
...
module.exports.show_forgot_password_success = [
    function(req, res) {
        res.render('forgot_password_success', { errorMessage: req.flash('errorMessage')[0], successMessage: req.flash('successMessage')[0] });
    }
];
